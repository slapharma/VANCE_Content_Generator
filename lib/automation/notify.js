  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;">
      <div style="background:#1e2d40;padding:20px 24px;border-bottom:3px solid #006868;">
        <span style="color:#fff;font-size:20px;font-weight:800;">Gastro Health Hub</span>
      ...
      <div style="padding:28px 24px;">
        ...
        <p style="color:#999;font-size:12px;margin-top:24px;">These links expire after 48h. Log in to the Gastro Health Hub dashboard to review manually.</p>
      </div>
    </div>`;
}
