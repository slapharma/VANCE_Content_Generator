...
async function postLinkedIn(data, acct) {
  ...
  // URL priority: kit's own link → configurable brand fallback. (The kit doesn't
  // currently store the published article URL; wire data.link through deploy/cron
  // to make each post link to its own article.)
