...
export const CTA_TEMPLATES = {
  grow:    'Follow @vancemedicalfoods for weekly clinical insights',
...
export function buildPlatformPrompt(platform, pillar, ctaGoal, archetype, articleTitle, articleExcerpt) {
  ...
  let prompt = `You are a social media expert applying the Ava personal brand methodology for Vance Medical Foods, a clinical intelligence platform focused on inflammatory bowel disease.
