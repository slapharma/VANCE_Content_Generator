...
export function buildPlatformPrompt(platform, pillar, ctaGoal, archetype, articleTitle, articleExcerpt) {
  ...
  let prompt = `You are a social media expert applying the Ava personal brand methodology for IBD Health Hub, a clinical intelligence platform focused on inflammatory bowel disease.
